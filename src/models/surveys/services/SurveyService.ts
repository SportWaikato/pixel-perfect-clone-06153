    ...
    return [
      {
        ...
        questions: [
          ...
          {
            question_text: "What sports are you most interested in?",
            question_type: "multi_select",
            answer_options: [
              "Football",
              "Netball",
      ...
      },
      {
        ...
        questions: [
          ...
          {
            question_text: "What stops you from being more active?",
            question_type: "multi_select",
            answer_options: [
              "Not enough time",
              "No transport to sport",
              "Cost of sport",
              "Don't know what sports are available",
              "No one to do it with",
              "Don't feel confident / shy",
      ...
      },
      {
        ...
        questions: [
          ...
          {
            question_text: "How satisfied are you with your sport experience at school?",
            question_type: "single_select",
            answer_options: [
              "Extremely satisfied",
              "Very satisfied",
          ...
          {
            question_text: "Do you play sport for a club or rep team outside school?",
            question_type: "single_select",
            answer_options: [
              "Yes - club team",
              "Yes - representative team",
              "Yes - both club and rep",
              "No",
            ],
            is_required: true,
            display_order: 4,
      ...
      {
        survey_type: "school_insights",
        name: "School Sport Insights",
        description: "Help Sport Waikato understand your sport experience",
        questions: [
          {
            question_text: "How satisfied are you with your sport experience at school?",
            question_type: "single_select",
          ...
          {
            question_text: "How satisfied are you with social sport? (playing for fun with friends)",
            question_type: "single_select",
            answer_options: [
              "Extremely satisfied",
              "Very satisfied",
              ...
              "Somewhat satisfied",
              "Not satisfied",
              "I don't play social sport",
            ],
            is_required: true,
            display_order: 2,
          },
          {
            question_text: "How satisfied are you with competitive sport? (games, tournaments)",
            question_type: "single_select",
            answer_options: [
              "Extremely satisfied",
              "Very satisfied",
              ...
              "Somewhat satisfied",
              "Not satisfied",
              "I don't play competitive sport",
            ],
            is_required: true,
            display_order: 3,
          },
          {
            question_text: "Do you play sport for a club or representative team outside school?",
            question_type: "single_select",
            answer_options: [
              "Yes - club team",
              "Yes - representative team",
          ...
          {
            question_text: "What sports are you most interested in? (pick your top 5)",
            question_type: "multi_select",
            answer_options: [
              "Football",
              "Netball",
          ...
          {
            question_text: "What stops you from being more active? (select all that apply)",
            question_type: "multi_select",
            answer_options: [
              "Not enough time",
              "No transport to sport",
              ...
              "Weather",
              "Don't enjoy sport",
              "No suitable teams for my level",
              "Nothing stops me",
            ],
            is_required: true,
            display_order: 6,
          ...
          {
            question_text: "Is there anything Sport Waikato could do to help you be more active?",
            question_type: "free_text",
            answer_options: null,
            is_required: false,
            display_order: 7,
