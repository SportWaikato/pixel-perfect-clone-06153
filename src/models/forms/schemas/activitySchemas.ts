...
import { MAX_ACTIVITY_DURATION_MINUTES, MAX_ACTIVITY_DAYS_AGO, MAX_ACTIVITIES_PER_DAY } from '@/models/activities/constants/activityValidationConstants';
...
export const logActivitySchema = object().shape({
  ...
  custom_activity_name: string()
    ...
    .when('activity_type', {
      is: 'something_else',
      then: (schema) => schema.required('Describe your activity').min(2, 'Enter at least 2 characters'),
