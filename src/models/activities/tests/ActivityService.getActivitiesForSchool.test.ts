...
function makeRawActivity(overrides: {
  ...
  return {
    ...
    user: { id: overrides.user_id, username: 'tester', first_name: 'Test', last_name: 'User', school_id: 'school-1', house: null },
  };
}

function setupSchoolMock(supabase: ReturnType<typeof makeSupabaseMock>, {
  schoolUsers,
  allActivities,
  pagedActivities,
}: {
