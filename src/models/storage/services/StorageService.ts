...
export class StorageService {
  ...
  async updateBadgeImage(oldStoragePath: string | null, newFile: File): Promise<{ storage_url: string; storage_path: string }> {
  ...
  async updateAssetFile(oldStoragePath: string | null, newFile: File): Promise<{ storage_url: string; storage_path: string }> {
    if (oldStoragePath) {
      try {
