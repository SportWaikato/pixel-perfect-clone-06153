...
function Page() {
  ...
  return <SchoolAdminDashboard user={user} viewingSchoolId={user.school_id} viewingSchoolName={user.school?.name ?? ''} viewingSchoolRegistrationMethod={user.school?.registration_method ?? null} />;
}
